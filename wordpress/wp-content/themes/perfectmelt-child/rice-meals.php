...
?>
    ...
    <div class="container">
        ...
        <div id="displayRiceMeals-posts" class="row mt-5 justify-content-center">
            <div class="col-lg-4 col-md-6 col-sm-12 mb-4 item">
                <div class="card d-inline-block">
                    <img class="card-img-top img-fluid" src="<?php echo theme_img_path;?>/rice-meals/4.png" alt="Card image cap">
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 mb-4 item">
                <div class="card d-inline-block">
                    <img class="card-img-top img-fluid" src="<?php echo theme_img_path;?>/rice-meals/5.png" alt="Card image cap">
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 mb-4 item">
                <div class="card d-inline-block">
                    <img class="card-img-top img-fluid" src="<?php echo theme_img_path;?>/rice-meals/6.png" alt="Card image cap">
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 mb-4 item">
                <div class="card d-inline-block">
                    <img class="card-img-top img-fluid" src="<?php echo theme_img_path;?>/rice-meals/3.png" alt="Card image cap">
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 mb-4 item">
                <div class="card d-inline-block">
                    <img class="card-img-top img-fluid" src="<?php echo theme_img_path;?>/rice-meals/1.png" alt="Card image cap">
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 mb-4 item">
                <div class="card d-inline-block">
                    <img class="card-img-top img-fluid" src="<?php echo theme_img_path;?>/rice-meals/2.png" alt="Card image cap">
                    <div class="card-body">
